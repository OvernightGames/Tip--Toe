...
public class SonarFXEnemy : MonoBehaviour {
	...
	void OnEnable()
	{
		GameObject player = GameObject.FindGameObjectWithTag("MainCamera")as GameObject;
		player.GetComponent<Camera>().SetReplacementShader(shader, null);
		Update();
	}
